...
Main = Library:Tab("เมนู",11446825283)
Farm = Library:Tab("ฟาร์ม/ทำเควาส",9260732790)
Stats = Library:Tab("สแตส",11447069304)
Combat = Library:Tab("ต่อสู้",11446900930)
Teleport = Library:Tab("วาป",11446920523)
Dungeon = Library:Tab("Raid/Esp",11446957539)
Fruit = Library:Tab("Fruit",11446965348)
Shop = Library:Tab("ซื้อของ",6031265976)
Misc = Library:Tab("รวม",11447063791)
RaceV4 = Library:Tab("ทำเผ่าV4",11446900930)
